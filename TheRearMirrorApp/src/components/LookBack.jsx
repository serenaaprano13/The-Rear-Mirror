...
function LookBack() {
  return (
    <Container fluid className="position-absolute top-0 mt-0">
      <Row>
      ...
      <Row>
        <Card className="w-100">
          <Card.Header>LESSON 07/09</Card.Header>
        ...
        <Card className="w-100">
          <Card.Header>LESSON 09/09</Card.Header>
          <Card.Body className="d-flex align-items-center"> {/* Allinea gli elementi al centro in altezza */}
            <div>
              <Card.Text>RED LIGHT</Card.Text>
              <Card.Text>ROUNDABOUT</Card.Text>
        ...
        <Card className="w-100">
          <Card.Header>LESSON 11/09</Card.Header>
          <Card.Body className="d-flex align-items-center"> {/* Allinea gli elementi al centro in altezza */}
            <div>
              <Card.Text>RED LIGHT</Card.Text>
              <Card.Text>ROUNDABOUT</Card.Text>
        ...
        <Card className="w-100">
          <Card.Header>LESSON 13/09</Card.Header>
          <Card.Body className="d-flex align-items-center"> {/* Allinea gli elementi al centro in altezza */}
            <div>
              <Card.Text>RED LIGHT</Card.Text>
              <Card.Text>ROUNDABOUT</Card.Text>
