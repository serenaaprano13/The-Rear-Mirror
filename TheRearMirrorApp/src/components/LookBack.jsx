      ...
      <Container fluid style={{ overflowY: 'auto' }}>
        <Row>
          <Card className="w-100">
            <Card.Header style={{ fontWeight: 'bold' }}>LESSON 07/09</Card.Header>
            <Card.Body className="d-flex align-items-center">
              <div>
                <Card.Text>RED LIGHT</Card.Text>
                <Card.Text>ROUNDABOUT</Card.Text>
                <Card.Text>SPEEDING</Card.Text>
              </div>
              <div className="ml-auto"> {/* Allinea il pulsante a destra */}
                <Button variant="primary">ask to evaluate</Button>
              </div>
            </Card.Body>
          </Card>
          <Card className="w-100">
            <Card.Header style={{ fontWeight: 'bold' }}>LESSON 09/09</Card.Header>
            <Card.Body className="d-flex align-items-center"> {/* Allinea gli elementi al centro in altezza */}
              <div>
                <Card.Text>RED LIGHT</Card.Text>
                <Card.Text>ROUNDABOUT</Card.Text>
                <Card.Text>SPEEDING</Card.Text>
          ...
          <Card className="w-100">
            <Card.Header style={{ fontWeight: 'bold' }}>LESSON 11/09</Card.Header>
            <Card.Body className="d-flex align-items-center"> {/* Allinea gli elementi al centro in altezza */}
              <div>
                <Card.Text>RED LIGHT</Card.Text>
                <Card.Text>ROUNDABOUT</Card.Text>
          ...
          <Card className="w-100">
            <Card.Header style={{ fontWeight: 'bold' }}>LESSON 13/09</Card.Header>
            <Card.Body className="d-flex align-items-center"> {/* Allinea gli elementi al centro in altezza */}
              <div>
                <Card.Text>RED LIGHT</Card.Text>
                <Card.Text>ROUNDABOUT</Card.Text>
